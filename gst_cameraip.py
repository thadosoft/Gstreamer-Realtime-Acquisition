...
from monitor.monitor import ResourceMonitor, ResourceMetrics
from processor.processor import FrameProcessor, DisplayProcessor
...
class VideoFrameCapture:
    ...
    def _process_frame(self, frame: np.ndarray, interval: float, metrics: ResourceMetrics):
        ...
        metadata = {"frame_count": self.performance.frame_count, "fps": self.performance.fps}
